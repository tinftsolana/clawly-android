...
├── PROJECT_SOUL.md        # Project vision, what Clawly is, high-level explanation
...
### PROJECT_SOUL.md
The heart and soul of Clawly:
- What Clawly is and its vision
- Core concept and Gateway architecture
- Key features and design philosophy
- Target users and what makes Clawly special
- Future direction and guiding principles

**When to read:** Understanding the product, onboarding new team members, making product decisions.
